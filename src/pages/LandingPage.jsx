        ...
        <div className="flex flex-col items-center">
            ...
            <Accordion type="multiple" className="w-full md:px-11 mt-4">
                <AccordionItem value="item-1">
                    ...
                    <AccordionContent>
                        When you enter a long URL, our system generates a shorter version of that URL. This shortened URL redirects to the original
                ...
                <AccordionItem value="item-3">
                    ...
                    <AccordionContent>
                        You can view the number of clicks, geolocation data of the clicks and device types (mobile/desktop) for each of your shortened
                        URLs.
                    </AccordionContent>
                </AccordionItem>
            </Accordion>
